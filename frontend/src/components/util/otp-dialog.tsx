...
export default function OtpDialog({ isOpen, onClose, onSuccess }: OtpDialogProps) {
      ...
      <DialogContent className="p-4 max-w-sm mx-auto">
        <div className="flex flex-col items-center gap-2">
          <div
            ...
            aria-hidden="true"
          >
            <KeyRound className="stroke-zinc-800 dark:stroke-zinc-100" size={20} aria-hidden="true" />
          </div>
          <DialogHeader>
